...
class VehicleReport extends Component {
  ...
  componentDidMount() {
    axios.get("http://localhost:8085/api/vehicles/").then((response) => {
    ...
    return (
      <div className="report">
        <Row>
          <Col sm="3"></Col>
          <Col sm="9">
            <h1 className="topicviewOfferreport">Vehicle Report</h1>
            <br></br>
            <button
            ...
            <div id="viewtable">
              ...
              <table className="table">
                ...
                {this.state.vehicles && this.state.vehicles.map((vehicle, index) => (
                    ...
                    >
                      <td style={{ paddingLeft: "0" }}>{vehicle.vehicleNo}</td>
