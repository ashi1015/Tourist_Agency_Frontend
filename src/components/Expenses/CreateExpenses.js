...
class CreateExpenses extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:8030/expenses/', expenses)
            .then(response => {
...
<br></br>
    ...
    //                     <label htmlFor="expenseType" className="form-label col">Expense Type</label>
    //                     <div className="midle col"> : </div>
    //                     <select
    ...
    //                 <div className="mb-3 row">
    //                     <label htmlFor="exmonth" className="form-label col">Expense Month</label>
    //                     <div className="midle col"> : </div>
    //                     <input
    //                         type="month"
    //                         id="exmonth"
    ...
    //                 <div className="mb-3 row">
    //                     <label htmlFor="amount" className="form-label col">Amount</label>
    //                     <div className="midle col"> : </div>
    //                     <input
    //                         type="Number"
    //                         className="form-control col"
