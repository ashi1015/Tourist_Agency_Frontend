...
export default class UpdateTouristguideComponent extends Component {
  ...
  updateDestination() {
    ...
    alert("Tourist Guide Updated Successfully!");
  ...
  deleteDestination() {
    ...
    alert("Tourist Guide Deleted Successfully!");
      ...
      <div>
        {currentDestination ? (
          <div className="edit-form">
            ...
            <h2 className="adminHeading">Update Tourist Guide</h2>

            <nav >
              <ol style={{backgroundColor: "white", marginLeft: "-15px"}} className="breadcrumb">
                <li className="breadcrumb-item"><a href="#">Home</a></li>
                <li className="breadcrumb-item"><a href="#">Admin</a></li>
                <li className="breadcrumb-item active" aria-current="page">Update Tourist Guide</li>
              </ol>
            </nav> <br/>
          ...
          <div>
            <br />
            <p>Please click on a Tourist Guide...</p>
          </div>
        )}
      </div>
    );
