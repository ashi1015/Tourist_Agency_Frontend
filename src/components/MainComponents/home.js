        ...
        return (
            ...
            <div >
                <div className="heading">
                    <p className="hotelMainHeading" style={{marginLeft: "200px", fontSize: "28px"}}>Explore Your Tour</p>
                ...
                <div className="col-md-12">
                    ...
                    <br/><br/>
                        ...
                        <p style={{marginTop: "50px", fontWeight: "bolder", fontSize: "20px"}}>Welcome To</p>
                        <h1 className="destinationHeading2"><b>Sri Lanka's Best Travel Agency</b></h1>
                ...
                <div style={{fontWeight: "bold"}}>
                    <p style={{marginLeft: "10px", fontSize: "18px"}}>Popular Destinations</p>
                    <br/>
                </div>
                        ...
                        <div className="column3">
                            <div className="card h-100" style={{width: "20rem"}}>
                                <div className="card-body">
                                    ...
                                    <p style={{fontSize: "11px"}}>{hotel.description}</p>
                                    <Link to={"/i/" + hotel.id} type="button" style={{fontWeight: "bold", fontSize: "11px"}} className="btn btn-info" style={{marginLeft: "25%"}}> More Details </Link>
                                </div>
                            </div>
                        </div>
                    ))}
                    <Link to={"/i/"} type="button" style={{fontWeight: "bold", fontSize: "11px"}} className="btn btn-primary" style={{marginLeft: "70%", marginTop: "15px", width: "200px"}}> Show More </Link>
                </div>
                <br/><br/>
                ...
                <br/><br/>
                <div style={{fontWeight: "bold"}}>
                    <p style={{marginLeft: "10px", fontSize: "18px"}}>Most Popular Hotels</p>
                    <br/>
                </div>
                <div className="row" style={{marginLeft: "30px"}}>
                    {hotels &&
                ...
                <br/><br/>
                <div style={{fontWeight: "bold"}}>
                    <p style={{marginLeft: "10px", fontSize: "18px"}}>Our Best Tourist Guides</p>
                    <br/>
                </div>
                <div className="row" style={{marginLeft: "30px"}}>
                    {hotels &&
