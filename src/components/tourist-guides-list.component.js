...
export default class TouristGuidesListComponent extends Component {
  ...
  render() {
    ...
    <div className="col-md-12">
        ...
        <h2 style={{marginLeft: "13px"}} className="adminHeading">List of Tourist Guides</h2>

        <nav >
          <ol style={{backgroundColor: "white"}} className="breadcrumb">
            <li className="breadcrumb-item"><a href="#">Home</a></li>
            <li className="breadcrumb-item"><a href="#">Admin</a></li>
            <li className="breadcrumb-item active" aria-current="page">List of Tourist Guides</li>
          </ol>
        </nav> <br/>
